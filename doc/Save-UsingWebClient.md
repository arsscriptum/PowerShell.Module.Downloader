...
```
Save-UsingWebClient [-Url] <String> [-DestinationPath] <String> [-Asynchronous] [-ProxyAddress <String>]
 [-ProxyUser <String>] [-ProxyPassword <String>] [-UserAgent <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
